...
with args.model.open("rb") as f:
  model = chamois.predictor.ChemicalOntologyPredictor.load(f)
...
if args.open:
    # path = folder.joinpath(args.output)
    webbrowser.open("file://{}".format(args.output.absolute()))
